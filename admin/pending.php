        ...
        <div class="row">
            ...
            <div class="card shadow py-2">
                <div class="card-body">
                    ...
                    <?php
                    $get_pending = mysqli_query($conn, "SELECT * FROM tbl_rentals LEFT JOIN users ON users.user_id = tbl_rentals.user_id LEFT JOIN cars ON cars.car_id = card_id WHERE  status = 'Pending'");
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $pend['car_name'] ?></td>
                                        <td><?php echo $pend['car_model'] ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="process.php?rental_id=<?php echo $pend['rental_id'] ?>&approve&car_id=<?php echo $pend['car_id'] ?>" onclick="return confirm('Do you want to confirm this reservation ?')" class="btn btn-success">Approve</a>
                                        </td>
