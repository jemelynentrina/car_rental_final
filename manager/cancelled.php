        ...
        <div class="row">
            ...
            <div class="card shadow py-2">
                <div class="card-body">
                    ...
                    <?php
                    $get_pending = mysqli_query($conn, "SELECT * FROM tbl_rentals LEFT JOIN users ON users.user_id = tbl_rentals.user_id LEFT JOIN cars ON cars.car_id = card_id WHERE  status = 'cancel' ");
